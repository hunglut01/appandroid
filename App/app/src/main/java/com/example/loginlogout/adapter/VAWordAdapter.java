...
public class VAWordAdapter extends RecyclerView.Adapter<WordHolder> {
    private List<Word> wordList;

    private Context context;

    public VAWordAdapter(List<Word> wordList, Context context) {
    ...
    public void onBindViewHolder(@NonNull WordHolder holder, int position) {
        ...
        holder.tvWord.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try
                {
                    compositeDisposable.add(API.saveWordva(id,word.word,word.html)
