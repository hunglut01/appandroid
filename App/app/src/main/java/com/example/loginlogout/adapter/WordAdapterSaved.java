...
public class WordAdapterSaved extends RecyclerView.Adapter<WordHolder2> {
    private List<Word> wordList;

    private Context context;

    public WordAdapterSaved(List<Word> wordList, Context context) {
    ...
    public void onBindViewHolder(@NonNull WordHolder2 holder, int position) {
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                compositeDisposable.add(API.deleteWord(word.word)
                        .subscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread()).subscribe(new Consumer<String>() {
                            @Override
                            public void accept(String s) throws Exception {
                                Toast.makeText(context, "Deleted", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(context, vocabulary_activity.class);
